...
::glossary-group{alphabet="A"}
    ...
    Auto-tracking
    #description
    The automatic and continuous tracking of data without manual intervention or the need for explicit tracking codes or tags. 
    ::
    ::accordion-block
    #title
