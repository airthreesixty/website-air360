    ...
    <div class="pb-8 px-4 mx-auto bg-gray-50 dark:bg-gray-900 sm:py-16 lg:px-6">
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3  md:gap-8 xl:gap-10 md:space-y-0">
        <div class="p-6 bg-white rounded shadow dark:bg-gray-800">
          ...
          <h3 class="mb-2 text-xl font-bold text-black-600 dark:text-white"><ContentSlot :use="$slots.title1" /></h3>
          <p class="font-light text-gray-500 dark:text-gray-400"><ContentSlot :use="$slots.description1" /></p>
        </div>
        <div class="p-6 bg-white rounded shadow dark:bg-gray-800">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl font-bold text-black-600 dark:text-white"><ContentSlot :use="$slots.title2" /></h3>
          <p class="font-light text-gray-500 dark:text-gray-400"><ContentSlot :use="$slots.description2" /></p>
        </div>
        <div class="p-6 bg-white rounded shadow dark:bg-gray-800">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl font-bold text-black-600 dark:text-white"><ContentSlot :use="$slots.title3" /></h3>
          <p class="font-light text-gray-500 dark:text-gray-400"><ContentSlot :use="$slots.description3" /></p>
        </div>
      </div>
    </div>
  </section>
