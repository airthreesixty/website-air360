<template>
  <LandingPage>
    <template #content>
      ...
      <nuxt-img src="/air360-cr-misteries.jpg" loading="lazy" width="456" class="w-35 sm:w-57 float-right shadow ml-5" />
      <p>It is no mistery that checkout abandonment is usually a significant pain or a common challenge in the eCommerce industry.</p>
...
useSeoMeta({
  ...
  ogTitle: title,
  ogImage: `${runtimeConfig.public.baseUrl}/air360-cr-misteries.jpg`,
