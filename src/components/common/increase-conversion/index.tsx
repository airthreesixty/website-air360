...
const IncreaseConversion = () => {
  ...
  return (
    <div className="m-auto text-center md:px-12 lg:px-20">
      <div className="relative mx-auto flex h-20 w-20 sm:h-24 sm:w-24 lg:w-28 lg:h-28 items-center justify-center">
        <MochiFlyingReverse className="relative w-full m-auto transform -scale-x-100 -rotate-6" />
      </div>
      <div>
        <h2 className="mb-4 font-really text-4xl font-bold text-black-600 mx-auto select-none sm:text-6xl lg:text-7xl">
          ...
          <br />
          <span className="px-2 overflow-visible m-0 leading-relaxed text-transparent bg-clip-text bg-gradient-to-r from-primary-600/70 to-primary-700/80">
