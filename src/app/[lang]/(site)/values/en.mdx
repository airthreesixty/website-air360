...
## Funding  
<div className="prose">
  <p className="m-0">Taking investors’ money and spending it like there’s no tomorrow is quite common in our industry.</p>
  <p className="m-0">We’re happy that Air360 lives from the money from its customers and enjoys an organic (yet fast) growth.</p>
  <p className="m-0">We have the freedom to execute on our long term vision while keeping our energy on solving our customers challenges.</p>
  <p className="m-0">Not being funded reminds us everyday that our customers are the ones putting food on our table. This helps us keep our priorities straight and is the core of all our decisions at all times.</p>
</div>
